...
theme.font = 'SF-Pro-Rounded-Regular 4'
...
local awesome_overrides =
  ...
  theme.font = 'SF-Pro-Rounded-Regular 10'
  theme.title_font = 'SF-Pro-Rounded-Regular 10'
  ...
  theme.tasklist_font = 'SF-Pro-Rounded-Regular 10'
